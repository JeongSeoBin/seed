...
public class CommonUtil
{
     ...
     * @return
     */
    public static Double roundWithDecimalPlace(Double base, int decimalPlace)
    {
        if (base == null)
            return null;
        ...
        double e = Math.pow(10, (double)decimalPlace);
    ...
    public static String getCronExpression(String time)
    {
        ...
        String hourStr = StringUtils.substring(time, 0, 2);
        String minStr = StringUtils.substring(time, 2, 4);
        String secStr = StringUtils.substring(time, 4, 6);
